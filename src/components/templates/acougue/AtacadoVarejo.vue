...
<template>
  <div class="w-full h-full relative overflow-hidden flex flex-col pt-4 px-4 poster-container border-8 border-red-700" :style="backgroundStyle">
    
    <!-- Header com Imagem Açougue -->
    <div class="relative w-full z-10 mb-2">
      <img :src="themeConfig.header.value" alt="Header Açougue" class="w-full h-auto object-contain" style="max-height: 12cqw;" />
    </div>
    ...
    <div class="flex-1 flex flex-col justify-center gap-4 text-center">
      ...
      <div class="bg-red-50 border-2 border-red-300 rounded-lg p-2 relative mx-4">
        <span class="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-red-700 text-white text-[3cqw] px-3 py-0.5 rounded-full uppercase font-bold tracking-wider">
          Unidade
        </span>
        <div class="flex items-baseline justify-center text-red-900 leading-none mt-2" :class="data.font">
      ...
      <div class="bg-yellow-400 border-4 border-red-800 rounded-xl p-4 relative shadow-lg transform scale-105 mx-2">
        <div class="absolute -top-4 left-0 w-full flex justify-center">
          <span class="bg-red-800 text-white text-[4cqw] px-4 py-1 rounded-md uppercase font-bold shadow-md transform -rotate-1">
            A partir de {{ data.minQuantity }} un
          </span>
        </div>
       
        <div class="flex items-baseline justify-center text-red-800 leading-none mt-4 drop-shadow-sm" :class="data.font">
          ...
          <div class="flex flex-col justify-start ml-1">
            ...
            <span class="text-[3cqw] text-red-900 font-bold uppercase mt-1">Nesta oferta</span>
          </div>
        </div>
      </div>
