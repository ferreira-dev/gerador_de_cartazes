...
<template>
  <div class="w-full h-full relative overflow-hidden flex flex-col poster-container border-8 border-red-700" :style="backgroundStyle">
    ...
    <!-- Produto -->
    <div class="w-full text-center flex flex-col items-center mb-4 px-4" :class="productInfoSpacingClass" style="margin-top: 26cqw;">
      <h2 
