...
<template>
  <div class="w-full h-full relative overflow-hidden flex flex-col items-center poster-container" :style="backgroundStyle">
    <!-- Header Section - Hortifruti: imagem temática -->
    ...
    <!-- Product Info -->
    <div class="flex-1 w-full flex flex-col items-center justify-start px-8 text-center z-10" :class="productInfoSpacingClass" style="margin-top: 20cqw;">
      <h2 
